...
const Footer = () => {
  return (
    <div className="  bg-bodyColor  h-full overflow-hidden cursor-pointer border-t-[1px] border-t-[#192E44]">
      ...
      <div className="flex flex-wrap justify-between gap-6 py-12 lg:px-8 px-4  lg:max-w-container lg:mx-auto">
        ...
        <div className="flex flex-col lg:w-[300px] w-full items-center text-center gap-2">
          ...
          <button className="w-full px-6 py-2 text-center font-bold font-Cuprum text-white bg-[#3657CD] mt-2  duration-300 hover:bg-textYellow hover:text-black">
            Subscribe now
          </button>
      ...
      <p className="text-sm font-Inter text-[#99A2AC] text-center pb-6">
        ...
        <span className="text-white font-Inter">FoodTime</span>
      </p>
